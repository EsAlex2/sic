...
CREATE TABLE unexca.inscripciones (
    id_inscripcion SERIAL PRIMARY KEY,
...
CREATE TABLE unexca.semestre_actual (
...
select * from unexca.usuarios;

SELECT * FROM unexca.secciones order by id_seccion asc;
select * from unexca.horarios;

INSERT INTO unexca.tipos_usuario (nombre_tipo, descripcion) VALUES
...
INSERT INTO unexca.pnf (id_sede, cod_pnf, nombre_pnf, descripcion, duracion_pnf, unidad_total_creditos) VALUES
...
INSERT INTO unexca.trayectos (cod_trayecto, descripcion) VALUES
...
INSERT INTO unexca.usuarios (cedula, nombres, apellidos, correo_institucional, password_hash, id_tipo) VALUES
('27391753', 'Alex Jonfranc', 'Madrid Marin', 'alexmadrid326@gmail.com', 'qwerty2801**', 1);

INSERT INTO unexca.turnos (turno, descripcion) VALUES
...
INSERT INTO unexca.aulas (piso, nro_aula, nombre_aula) VALUES
-- Piso 1
...
INSERT INTO unexca.datos_estudiantes (
    id_tipo, 
    id_estatus, 
    cedula_identidad, 
    nombres_estudiante, 
...
INSERT INTO unexca.estatus (nombre_estatus, descripcion) VALUES
...
INSERT INTO unexca.aranceles (id_estatus, descripcion, monto) VALUES
...
INSERT INTO unexca.requisitos (nombre_requisito, categoria_estudiante, descripcion, es_obligatorio)
VALUES 
...
INSERT INTO unexca.sedes_unexca (nombre_sede, correo_institucional, direccion) 
VALUES 
(
    'Sede Altagracia ', 
